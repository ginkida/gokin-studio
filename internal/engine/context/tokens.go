...
var DefaultModelLimits = map[string]TokenLimits{
	...
	// DeepSeek V4 — both models share 128K context, 8K output budget.
	"deepseek-v4-pro": {
		MaxInputTokens:  128000,
		MaxOutputTokens: 8192,
	},
...
var DefaultPricing = map[string]ModelPricing{
	...
	// DeepSeek V4 (USD per 1M tokens, published rates)
	...
	"kimi-for-coding":        {InputCostPer1M: 0.56, OutputCostPer1M: 2.24},
